...
static const BrushInfo BRUSHES[] = {
    { ScribbleArea::Normal,      "",  "Normal"             },
    { ScribbleArea::Spray,       "",  "Spray"          },
    { ScribbleArea::Marker,      "",  "Marker"         },
    { ScribbleArea::Glow,        "",  "Glow"            },
    { ScribbleArea::Watercolor,  "",  "Watercolor"     },
    { ScribbleArea::Calligraphy, "",  "Kaligrafi"       },
    { ScribbleArea::Fur,         "",  "Fur"                 },
    { ScribbleArea::Chalk,       "",  "Chalk"       },
};
